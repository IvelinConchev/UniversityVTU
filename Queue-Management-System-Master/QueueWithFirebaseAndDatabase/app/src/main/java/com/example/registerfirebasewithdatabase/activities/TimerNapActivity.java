...
public class TimerNapActivity extends AppCompatActivity {
    TextView textView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_timer_nap);
        ...
        new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(TimerNapActivity.this, NapAreaActivity.class);
